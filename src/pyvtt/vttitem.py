# -*- coding: utf-8 -*-
"""
VTT's subtitle parser
"""

from pyvtt.vttexc import InvalidItem, InvalidIndex
from pyvtt.vtttime import VTTTime
from pyvtt.comparablemixin import ComparableMixin
from pyvtt.compat import str, is_py2
import re

class VTTItem(ComparableMixin):
    """
    VTTItem(index, start, end, text, position)

    index -> int: index of item in file. 0 by default.
    start, end -> VTTTime or coercible.
    ...
    def __init__(self, index=0, start=None, end=None, text='', position=''):
        ...
        self.start = VTTTime.coerce(start or 0)
        self.end = VTTTime.coerce(end or 0)
